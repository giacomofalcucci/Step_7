...
!
        ...
        write(52,'(A11,I10,A1,I10,A1,I10)') 'DIMENSIONS ',nx,' ',ny/2,' ',1
        write(52,'(A7,I10,A1,I10,A1,I10)')  'ORIGIN ',1,' ' &
                                                     ,1,' ' &
                                                     ,1
        write(52,'(A8,I10,A1,I10,A1,I10)') 'SPACING ',1,' ',1,' ',1
        write(52,'(A10,I10)')'POINT_DATA ',nx*ny/2*1
! write scalar
...
#ifdef DEBUG
        write(6,*) "DEBUG: Completed subroutine out2d_rho"
#endif
